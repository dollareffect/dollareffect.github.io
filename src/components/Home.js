...
export default class Home extends Component {
  ...
  handleClick = (event) => {
    ...
    } else if (event.target.id === 'btnShowModalVideo') {
      this.setState({ isModalVideoVisible: true });
    } else if (event.target.id === 'btnShowModalApplication') {
      this.setState({ isModalApplicationVisible: true }, () => {
        setTimeout(() =>{
          self.refInputOrganizationName.current.focus();
        }, 300);
      });
    } else if (event.target.id === 'btnSubmitApplication') {
      this.validateForm();
    }
  ...
  handleChange = (event) => {
    ...
    if (id === 'inputOrganizationName') {
      state = { inputOrganizationName: value };
    } else if (id === 'inputOrganizationFBPage') {
      state = { inputOrganizationFBPage: value };
    } else if (id === 'inputOrganizationTwitter') {
      state = { inputOrganizationTwitter: value };
    } else if (id === 'inputOrganizationWebsite') {
      state = { inputOrganizationWebsite: value };
    } else if (id === 'inputOrganizationFullName') {
      state = { inputOrganizationFullName: value };
    } else if (id === 'inputOrganizationEmail') {
      state = { inputOrganizationEmail: value };
    } else if (id === 'inputOrganizationCountryCode') {
      state = { inputOrganizationCountryCode: value };
    } else if (id === 'inputOrganizationPhone') {
      state = { inputOrganizationPhone: value };
    } else if (id === 'inputOrganizationMessage') {
      state = { inputOrganizationMessage: value };
    }
          ...
          <div className="container">
            <div className="row">
              <div className="col-lg-5 col-md-7">
                ...
                <button id="btnShowModalVideo" className="btn btn-ico-action" onClick={this.handleClick}><i
                ...
                <p className="mb50">The Dollar Effect is a monthly subscription of $1 dollar to a non-profit
                                    of your choice.</p>
                <div>
                  <button id="donate" className="btn btn-primary" onClick={this.handleClick}>Donate</button>
                  <button
                    id="learnMore"
              ...
              <div className="col-sm-10 offset-sm-1">
                <div className="row">
                  <div className="col-md-12 col-lg-6">
                    <div className="de-feature-wrapper">
                      <div className="feature-icon">
                        <img src="src/img/oval-heart.png" alt="" />
                      </div>
                  ...
                  <div className="col-md-12 col-lg-6">
                    <div className="de-feature-wrapper">
                      <div className="feature-icon">
                        <img src="src/img/oval-set.png" alt="" />
                      </div>
                      <div className="feature-content">
                  ...
                  <div className="col-md-12 col-lg-6">
                    <div className="de-feature-wrapper">
                      <div className="feature-icon">
                        <img src="src/img/oval-dollar.png" alt="" />
                      </div>
                      <div className="feature-content">
                  ...
                  <div className="col-md-12 col-lg-6">
                    <div className="de-feature-wrapper">
                      <div className="feature-icon">
                        <img src="src/img/oval-connected.png" alt="" />
                      </div>
                      <div className="feature-content">
                        <h5>Be Connected</h5>
            ...
            <div className="row">
              <div className="col-lg-3">
                <div className="form-group de-form-group">
                  ...
                  <input
                    id="inputOrganizationCountryCode"
        ...
        >
          <Modal.Body>
            <div className="modal-body de-modal-body p50 text-center">
              <img className="mb30" src="src/img/icon-ok.png" />
              <h4>Awesome!</h4>
